...
# that was scraped from the urls in Jupyter Notebook. Convert the Jupyter notebook into a Python 
# script with a function called scrape that will execute all of your scraping code from above and 
...
# Function to execute all code scraping
def scrape_all():
    # Initialize a headless chrome browser driver in splinter
...
def mars_news(browser):
    ...
    try:
        ...
        # Use the parent element to find the paragraph text and save it as 'news_p'
